   ...
   addAccessory(device, hbDeviceId, type) {
      ...
      try {
         ...
         case "zb_sub":
            ...
            case 1000:
               accessory.addService(Service.StatelessProgrammableSwitch).getCharacteristic(Characteristic.ProgrammableSwitchEvent);
               break;
            case 1770:
               accessory.addService(Service.TemperatureSensor);
               accessory.addService(Service.HumiditySensor);
      ...
      try {
         ...
         case 1000:
            if (params.hasOwnProperty("key")) {
               ...
               let value = Characteristic.ProgrammableSwitchEvent.SINGLE_PRESS;
               ...
               case 2:
                  ...
                  break;
               default:
                  this.log.warn("[%s] could not be updated - [%s].", accessory.displayName, value);

                  return;   
               }

               let service = accessory.getService(Service.StatelessProgrammableSwitch);
               let programmableSwitchEventCharacteristic = service.getCharacteristic(Characteristic.ProgrammableSwitchEvent);
