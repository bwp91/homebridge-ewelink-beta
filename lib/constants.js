...
module.exports = {
   ...
   packageName: "homebridge-ewelink-beta",
   ...
   paramsToKeep: ["bright", "brightness", "channel", "colorB", "colorG", "colorR", "currentHumidity", "currentTemperature", "fan", "humidity", "key", "light", "lock", "mainSwitch", "mode", "online", "rfList", "rfTrig", "sensorType", "speed", "state", "switch", "switches", "temperature", "type", "zyx_mode"],
   chansFromUiid: {
