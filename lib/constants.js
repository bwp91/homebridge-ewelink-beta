...
module.exports = {
   ...
   devicesRFBridge: [28],
   devicesZBBridge: [66],
   paramsToKeep: ["bright", "brightness", "channel", "colorB", "colorG", "colorR", "currentHumidity", "currentTemperature", "fan", "light", "mainSwitch", "mode", "online", "rfList", "rfTrig", "sensorType", "speed", "state", "subDevices", "switch", "switches", "type", "zyx_mode"],
   chansFromUiid: {
